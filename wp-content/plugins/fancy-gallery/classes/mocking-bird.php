...
abstract class Mocking_Bird {
  ...
  static function printLighboxBranding(){
    ...
    <div style="display:block;position:absolute;top:0;left:0;width:100%;text-align:center;line-height:1.1em">
      <a href="<?php echo static::getProNotice('upgrade_url') ?>" title="<?php echo static::getProNotice('upgrade') ?>" target="_blank" style="display:inline-block;background:rgb(70,180,80);border-radius:0 0 7px 7px;font-size:1em;padding:7px;line-height:inherit;color:white;text-decoration:none">
